        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 className="text-3xl font-bold tracking-[0.1em]">
              <FontAwesomeIcon icon={faTrashCan} className="mr-2 text-blue-300" />Delete Organization
            </h1>
          </div>
          <p className="text-sm text-blue-300 tracking-widest">オーガナイゼーションを削除</p>
        </div>
      </div>
      {/* Content */}
      <div className="container mx-auto px-4 py-10 max-w-2xl">
        <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-100 shadow-sm">
          <form onSubmit={handleSubmit}>
            <p className="text-center text-slate-700 mb-6">オーガナイゼーションを<br />削除しますか？</p>
            <button type="submit" className="w-full bg-red-500 hover:bg-red-600 text-white text-sm font-medium py-3 px-4 rounded-xl transition-colors">
