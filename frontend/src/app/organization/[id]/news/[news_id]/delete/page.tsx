...
export default function News({ params }: { params: Promise<{ id: string, news_id: string }>}) {
  ...
  const url = process.env.NEXT_PUBLIC_API_URL + `/organization/${id}/news/${news_id}/delete/`;
  ...
  return (
    <main className="pb-16">
      ...
      <div className="container mx-auto px-4 py-10 max-w-2xl">
        ...
        <Link href={`/organization/${id}/news/${news_id}`} className="mt-6 flex items-center justify-center gap-1.5 text-sm text-blue-600 hover:text-blue-800 transition-colors">
